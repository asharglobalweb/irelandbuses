...
const service = {
    ...
    span: 'School Trips',
    subTitle: 'Make every school trip memorable with Ireland Buses — safe, comfortable, and expertly managed transport for students and teachers across Ireland.',
    image: '/images/scht4.png'
}

const tripDetail = {
    h2: 'About Our School Trip Service',
    title: 'Ireland Buses provides reliable and enjoyable school trip transport across Ireland. From museums to theme parks, our modern coaches, experienced drivers, and advanced safety features ensure every journey is smooth, secure, and fun for everyone.',
    features: [
